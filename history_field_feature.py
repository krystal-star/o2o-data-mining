...
def get_history_field_user_feature(label_field, history_field):
    ...
    u_feat[prefixs + 'receive_and_consume_differ_rate_15'] = list(map(lambda x, y: x / y if y != 0 else 0,
                                                                      u_feat[
                                                                          prefixs + 'receive_and_consume_15_differ_cn'],
...
def get_history_field_feature(label_feild, history_field):
    ...
    # 不同特征块的交互特征
    history_feat['history_field_User_id_Merchant_id_receive_not_consume_rate_in_User_id'] = list(
        map(lambda x, y: x / y if
        y != 0 else 0, history_feat['history_field_User_id_Merchant_id_receive_not_consume_cnt'],
            history_feat['history_field_User_id_Merchant_id_receive_not_consume_cnt']))

    history_feat['history_field_User_id_Merchant_id_receive_and_consume_rate_in_User_id'] = list(
        map(lambda x, y: x / y if
        y != 0 else 0, history_feat['history_field_User_id_Merchant_id_receive_and_consume_cnt'],
            history_feat['history_field_User_id_Merchant_id_receive_and_consume_cnt']))

    history_feat['history_field_User_id_Merchant_id_receive_and_consume_rate_in_Merchant_id'] = list(
        map(lambda x, y: x / y if
        y != 0 else 0, history_feat['history_field_User_id_Merchant_id_receive_and_consume_cnt'],
            history_feat['history_field_User_id_Merchant_id_receive_and_consume_cnt']))
